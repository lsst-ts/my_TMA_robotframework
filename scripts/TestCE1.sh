#!/bin/bash
#  Shellscript to create test suites for Test CE1 (Commanding Engineering 1).
#  Check all possible commands with Ack-Done response. Verify the correct reception of all the data associated to the 
...
workDir=$HOME/LSST/robotframework_TMA/OPERATION_MANAGER/Test_CE1
...
function createSettings() {
  ...
  echo "Force Tags    Test_CE1" >> $testSuite
	echo "" >> $testSuite
}
