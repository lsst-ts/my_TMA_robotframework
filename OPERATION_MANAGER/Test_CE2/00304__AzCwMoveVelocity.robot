*** Settings ***
Documentation    Execute AZ_CW_MOVE_VELOCITY command and get Ack/Error responses.
Library    SSHLibrary
Library    String
...
Verify PXI Message
    ...
    Should Match Regexp    ${output}    [1-9][0-9]*-[1-9][0-9]*-304-2-[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}\.[0-9]{6}-9\\.835265-6\\.139397-2\\.189297
