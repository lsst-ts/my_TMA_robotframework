*** Settings ***
Documentation    Execute CAM_CW_MOVE_VELOCITY command and get Ack/Error responses.
Library    SSHLibrary
Library    String
...
Verify PXI Message
    ...
    Should Match Regexp    ${output}    [1-9][0-9]*-[1-9][0-9]*-1008-2-[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}\.[0-9]{6}-3\\.535273-1\\.988834-30\\.892242
