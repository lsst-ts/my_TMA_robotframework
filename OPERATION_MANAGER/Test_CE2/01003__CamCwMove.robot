*** Settings ***
Documentation    Execute CAM_CW_MOVE command and get Ack/Error responses.
Library    SSHLibrary
Library    String
...
Verify PXI Message
    ...
    Should Match Regexp    ${output}    [1-9][0-9]*-[1-9][0-9]*-1003-2-[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}\.[0-9]{6}-160\\.833011-6\\.449324-3\\.437676-37\\.207806
