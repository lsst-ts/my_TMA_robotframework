*** Settings ***
Documentation    Execute OSS_POWER_OIL command and get Ack/Done responses.
Library    SSHLibrary
Library    String
...
Verify PXI Message
    ...
    Should Match Regexp    ${output}    [1-9][0-9]*-[1-9][0-9]*-803-2-[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}\.[0-9]{6}-1
